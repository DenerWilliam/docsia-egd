# Comparativo: report_xlsx

## Informações do Módulo

| Campo | Valor |
|-------|-------|
| Nome Técnico | report_xlsx |
| Nome Amigável | Relatório XLSX |
| Autor | OCA/reporting-engine |
| Repositório | https://github.com/OCA/reporting-engine |
...
|--------|---------------------|
| v15 | Templates avançados |
| v16 | Múltiplas planilhas |
| v17 | Interface completely redesigned |
| v18 | Formatação condicional |
| v19 | AI-powered report generation |
...
- Módulo muito útil para exportação Excel
