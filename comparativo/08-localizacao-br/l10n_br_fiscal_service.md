# Comparativo: l10n_br_fiscal_service

## Informações do Módulo

| Campo | Valor |
|-------|-------|
| Nome Técnico | l10n_br_fiscal_service |
| Nome Amigável | Serviço Fiscal Brasileiro |
...
|--------|---------------------|
| v15 | Serviços adicionais |
| v16 | Múltiplos serviços |
| v17 | Interface completely redesigned |
| v18 | Validação automática |
| v19 | AI-powered service validation |
