# Comparativo: l10n_br_sale_order_secondary_unit

## Informações do Módulo

| Campo | Valor |
|-------|-------|
| Nome Técnico | l10n_br_sale_order_secondary_unit |
| Nome Amigável | Unidade Secundária Ordem Venda |
...
### Odoo 14 (Base)
- Unidade secundária em ordens de venda
...
|--------|---------------------|
| v15 | Unidades adicionais |
| v16 | Múltiplas unidades |
| v17 | Interface completely redesigned |
| v18 | Validação automática |
| v19 | AI-powered unit management |
