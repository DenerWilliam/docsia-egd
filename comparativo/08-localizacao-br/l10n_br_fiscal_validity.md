# Comparativo: l10n_br_fiscal_validity

## Informações do Módulo

| Campo | Valor |
|-------|-------|
| Nome Técnico | l10n_br_fiscal_validity |
| Nome Amigável | Validade Fiscal |
...
|--------|---------------------|
| v15 | Validações adicionais |
| v16 | Múltiplos documentos |
| v17 | Interface completely redesigned |
| v18 | Validação automática |
| v19 | AI-powered validity checking |
