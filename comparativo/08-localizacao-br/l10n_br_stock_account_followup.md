# Comparativo: l10n_br_stock_account_followup

## Informações do Módulo

| Campo | Valor |
|-------|-------|
| Nome Técnico | l10n_br_stock_account_followup |
| Nome Amigável | Acompanhamento Contábil Estoque |
...
### Odoo 14 (Base)
- Acompanhamento contábil de estoque
...
### Odoo 16 (LTS)
- Suporte a múltiplos acompanhamentos
...
|--------|---------------------|
| v15 | Funcionalidades adicionais |
| v16 | Múltiplos acompanhamentos |
| v17 | Interface completely redesigned |
| v18 | Validação automática |
| v19 | AI-powered followup management |

## Migração

| De → Para | Complexidade | Tempo Estimado |
|-----------|--------------|----------------|
| v14 → v15 | Baixa | 1-2 dias |
| v15 → v16 | Baixa | 1-2 dias |
| v16 → v17 | Média | 2-3 dias |
| v17 → v18 | Baixa | 1-2 dias |
| v18 → v19 | Baixa | 1-2 dias |
