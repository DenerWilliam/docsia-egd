# Comparativo: l10n_br_nfe_spec

## Informações do Módulo

| Campo | Valor |
|-------|-------|
| Nome Técnico | l10n_br_nfe_spec |
| Nome Amigável | Especificação NF-e |
...
### Odoo 16 (LTS)
- Suporte a múltiplas especificações
...
|--------|---------------------|
| v15 | Especificações adicionais |
| v16 | Múltiplas especificações |
| v17 | Interface completely redesigned |
| v18 | Validação automática |
| v19 | AI-powered NF-e specification |
