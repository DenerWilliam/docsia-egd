# Comparativo: l10n_br_sale_stock

## Informações do Módulo

| Campo | Valor |
|-------|-------|
| Nome Técnico | l10n_br_sale_stock |
| Nome Amigável | Vendas Estoque Brasileiro |
...
### Odoo 14 (Base)
- Integração vendas-estoque brasileira
- CFOP de saída
- Validação fiscal
- Relatórios
...
| v19 | AI-powered sale stock validation |
