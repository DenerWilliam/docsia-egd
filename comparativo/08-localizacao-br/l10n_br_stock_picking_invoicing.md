# Comparativo: l10n_br_stock_picking_invoicing

## Informações do Módulo

| Campo | Valor |
|-------|-------|
| Nome Técnico | l10n_br_stock_picking_invoicing |
| Nome Amigável | Faturamento Picking Brasileiro |
...
### Odoo 14 (Base)
- Faturamento de picking brasileiro
