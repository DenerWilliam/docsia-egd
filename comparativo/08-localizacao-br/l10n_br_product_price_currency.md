# Comparativo: l10n_br_product_price_currency

## Informações do Módulo

| Campo | Valor |
|-------|-------|
| Nome Técnico | l10n_br_product_price_currency |
| Nome Amigável | Moeda Preço Produto |
